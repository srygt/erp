    ...
    public function store(FaturaEkleRequest $request)
    {
        ...
        $fatura = $faturaTaslagi
            ...
            ->create([
                ...
                Fatura::COLUMN_GUNDUZ_TUKETIM       => $faturaTaslagi->{Fatura::COLUMN_GUNDUZ_TUKETIM},
                Fatura::COLUMN_PUAND_TUKETIM        => $faturaTaslagi->{Fatura::COLUMN_PUAND_TUKETIM},
                Fatura::COLUMN_GECE_TUKETIM         => $faturaTaslagi->{Fatura::COLUMN_GECE_TUKETIM},
