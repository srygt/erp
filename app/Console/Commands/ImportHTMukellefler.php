...
class ImportHTMukellefler extends Command
{
     ...
     * @var string
     */
    protected $signature = 'import:ht-mukellefler'
     ...
     * @var string
     */
    protected $description = 'Imports the mukellefs from hizli teknoloji csv file';
    ...
    public function handle()
    {
        ...
        $importService = app(ImportMukellefler::class);
