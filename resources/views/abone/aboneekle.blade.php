    ...
    <div class="row clearfix">
        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                @endif
                <form {{route("aboneeklePost")}} method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>VKN/TCKN<span class="text-danger">*</span></label>
                                <input class="form-control" name="vkn_tckn" type="text" value="">
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-12">
                            <div class="form-group">
                                <label>Unvan<span class="text-danger">*</span></label>
                                <input class="form-control" name="unvan" value="" type="text">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Adı</label>
                                <input class="form-control" name="ad" value="" type="text">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Soyadı</label>
                                <input class="form-control" name="soyad" value="" type="text">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Abone Tipi <span class="text-danger">*</span></label>
                                <select class="form-control" name="abonetipi">
